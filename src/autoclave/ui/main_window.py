...
from src.autoclave.ui.ui_cycle.cycle_window import CycleWindow
from src.autoclave.ui.ui_menus.ui_menu import UIMenu
from src.autoclave.core.status import estado 
#configuracion del logger
logger = logging.getLogger(__name__)
#variables globales de la interfaz
estado_puerta_1 = 1  # 0: Abierta, 1: Cerrada
estado_puerta_2 = 1  # 0: Abierta, 1: Cerrada
titulo_ciclo_texto = "Bowie and Dick"
valor = estado.sensores_temp.get("temp_camara", "---")
...
class InterfazPrincipal(tk.Tk):
    ...
    def __init__(self):
        ...
        #variables globales de la interfaz
        self.prep_ciclo= tk.StringVar(value="No preparado")
        self.alarmas_activas = ["Puerta abierta", "Nivel de agua bajo"]
...
#-----------------------------------------------------------------------
        def boton_puerta():
            ...
            #tendra una imagen de puerta hubicada en src/autoclave/images/open_door.png
            if estado_puerta_1 == 1:
                img= ctk.CTkImage(
                    light_image=image.open("src/autoclave/images/close_door_1.png"),
                    dark_image=image.open("src/autoclave/images/close_door_1.png"),
                    size=(200, 100),
                )
            elif estado_puerta_1 == 0:
                img= ctk.CTkImage(
                    light_image=image.open("src/autoclave/images/open_door_1.png"),
                    dark_image=image.open("src/autoclave/images/open_door_1.png"),
                    size=(200, 100),
                )
        ...
        def puerta_2():
            ...
            if estado_puerta_2 == 1:
                img= ctk.CTkImage(
                    light_image=image.open("src/autoclave/images/close_door_2.png"),
                    dark_image=image.open("src/autoclave/images/close_door_2.png"),
                    size=(200, 100),
                )
            elif estado_puerta_2 == 0:
                img= ctk.CTkImage(
                    light_image=image.open("src/autoclave/images/open_door_2.png"),
                    dark_image=image.open("src/autoclave/images/open_door_2.png"),
                    size=(200, 100),
                )
            else:
                img= ctk.CTkImage(
                    light_image=image.open("src/autoclave/images/error_door.png"),
                    dark_image=image.open("src/autoclave/images/error_door.png"),
                    size=(200, 100),
                )
            puerta_dos = ctk.CTkLabel(
                fondo,
                text="",
                image=img,
            )
        ...
        def boton_iniciar_ciclo():
            ...
            img= ctk.CTkImage(
                light_image=image.open("src/autoclave/images/start_cycle.png"),
                dark_image=image.open("src/autoclave/images/start_cycle.png"),
                size=(200, 100),
            )
    ...
    def _pie_pagina(self):
        ...
        pie_pagina = components._crear_pie_pagina(
            self,
            rx=0.2,
            ry=0.85,
            rw=0.6,
        ...
        def boton_info(pie_pagina):
            ...
            img= ctk.CTkImage(
                light_image=image.open("src/autoclave/images/info_icon.png"),
                dark_image=image.open("src/autoclave/images/info_icon.png"),
                size=(80, 40),
            )
        ...
        def boton_login(pie_pagina):
            ...
            #y centrado verticalmente en el pie de pagina
            img= ctk.CTkImage(
                light_image=image.open("src/autoclave/images/login_icon.png"),
                dark_image=image.open("src/autoclave/images/login_icon.png"),
                size=(100, 50),
            )
        ...
        def boton_apagar(pie_pagina):
            ...
            img= ctk.CTkImage(
                light_image=image.open("src/autoclave/images/power_icon.png"),
                dark_image=image.open("src/autoclave/images/power_icon.png"),
                size=(80, 40),
            )
    ...
    def login_user(self):
        ...
        menu_window = UIMenu(self)
        menu_window.grab_set()
        
    def actualizar_sensores(self,):
        #funcion para actualizar el valor de la temperatura de la camara
        valor_temp = tuple(estado.sensores_temp.values())
        valor_pres = tuple(estado.sensores_pres.values())
        self.temp_cam.configure(text=str(valor_temp[0]))
        self.temp_ref.configure(text=str(valor_temp[1]))
        
        self.pres_cam.configure(text=str(valor_pres[0]))
